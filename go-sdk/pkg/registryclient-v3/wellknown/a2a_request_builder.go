...
// A2aRequestBuilder builds and executes requests for operations under \.well-known\a2a
...
// Get get the agent card (A2A v1 path)
...
// ToGetRequestInformation get the agent card (A2A v1 path)
