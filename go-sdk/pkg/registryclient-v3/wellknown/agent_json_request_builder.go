...
// AgentJsonRequestBuilder builds and executes requests for operations under \.well-known\agent.json
...
// Get get the agent card for this registry instance
...
// ToGetRequestInformation get the agent card for this registry instance
